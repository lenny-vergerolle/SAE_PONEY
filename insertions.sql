...
(1, 'Lundi', STR_TO_DATE('08:00', '%H:%i'), STR_TO_DATE('09:00', '%H:%i')),
(2, 'Lundi', STR_TO_DATE('09:00', '%H:%i'), STR_TO_DATE('10:00', '%H:%i')),
(3, 'Lundi', STR_TO_DATE('10:00', '%H:%i'), STR_TO_DATE('11:00', '%H:%i')),
(4, 'Lundi', STR_TO_DATE('11:00', '%H:%i'), STR_TO_DATE('12:00', '%H:%i')),
(5, 'Lundi', STR_TO_DATE('13:00', '%H:%i'), STR_TO_DATE('14:00', '%H:%i')),
(6, 'Lundi', STR_TO_DATE('14:00', '%H:%i'), STR_TO_DATE('15:00', '%H:%i')),
(7, 'Lundi', STR_TO_DATE('15:00', '%H:%i'), STR_TO_DATE('16:00', '%H:%i')),
(8, 'Lundi', STR_TO_DATE('16:00', '%H:%i'), STR_TO_DATE('17:00', '%H:%i')),
(9, 'Lundi', STR_TO_DATE('17:00', '%H:%i'), STR_TO_DATE('18:00', '%H:%i')),
(10, 'Mardi', STR_TO_DATE('08:00', '%H:%i'), STR_TO_DATE('09:00', '%H:%i')),
(11, 'Mardi', STR_TO_DATE('09:00', '%H:%i'), STR_TO_DATE('10:00', '%H:%i')),
(12, 'Mardi', STR_TO_DATE('10:00', '%H:%i'), STR_TO_DATE('11:00', '%H:%i')),
(13, 'Mardi', STR_TO_DATE('11:00', '%H:%i'), STR_TO_DATE('12:00', '%H:%i')),
(14, 'Mardi', STR_TO_DATE('13:00', '%H:%i'), STR_TO_DATE('14:00', '%H:%i')),
(15, 'Mardi', STR_TO_DATE('14:00', '%H:%i'), STR_TO_DATE('15:00', '%H:%i')),
(16, 'Mardi', STR_TO_DATE('15:00', '%H:%i'), STR_TO_DATE('16:00', '%H:%i')),
(17, 'Mardi', STR_TO_DATE('16:00', '%H:%i'), STR_TO_DATE('17:00', '%H:%i')),
(18, 'Mardi', STR_TO_DATE('17:00', '%H:%i'), STR_TO_DATE('18:00', '%H:%i')),
(19, 'Mercredi', STR_TO_DATE('08:00', '%H:%i'), STR_TO_DATE('09:00', '%H:%i')),
(20, 'Mercredi', STR_TO_DATE('09:00', '%H:%i'), STR_TO_DATE('10:00', '%H:%i')),
(21, 'Mercredi', STR_TO_DATE('10:00', '%H:%i'), STR_TO_DATE('11:00', '%H:%i')),
(22, 'Mercredi', STR_TO_DATE('11:00', '%H:%i'), STR_TO_DATE('12:00', '%H:%i')),
(23, 'Mercredi', STR_TO_DATE('13:00', '%H:%i'), STR_TO_DATE('14:00', '%H:%i')),
(24, 'Mercredi', STR_TO_DATE('14:00', '%H:%i'), STR_TO_DATE('15:00', '%H:%i')),
(25, 'Mercredi', STR_TO_DATE('15:00', '%H:%i'), STR_TO_DATE('16:00', '%H:%i')),
(26, 'Mercredi', STR_TO_DATE('16:00', '%H:%i'), STR_TO_DATE('17:00', '%H:%i')),
(27, 'Mercredi', STR_TO_DATE('17:00', '%H:%i'), STR_TO_DATE('18:00', '%H:%i')),
(28, 'Jeudi', STR_TO_DATE('08:00', '%H:%i'), STR_TO_DATE('09:00', '%H:%i')),
(29, 'Jeudi', STR_TO_DATE('09:00', '%H:%i'), STR_TO_DATE('10:00', '%H:%i')),
(30, 'Jeudi', STR_TO_DATE('10:00', '%H:%i'), STR_TO_DATE('11:00', '%H:%i')),
(31, 'Jeudi', STR_TO_DATE('11:00', '%H:%i'), STR_TO_DATE('12:00', '%H:%i')),
(32, 'Jeudi', STR_TO_DATE('13:00', '%H:%i'), STR_TO_DATE('14:00', '%H:%i')),
(33, 'Jeudi', STR_TO_DATE('14:00', '%H:%i'), STR_TO_DATE('15:00', '%H:%i')),
(34, 'Jeudi', STR_TO_DATE('15:00', '%H:%i'), STR_TO_DATE('16:00', '%H:%i')),
(35, 'Jeudi', STR_TO_DATE('16:00', '%H:%i'), STR_TO_DATE('17:00', '%H:%i')),
(36, 'Jeudi', STR_TO_DATE('17:00', '%H:%i'), STR_TO_DATE('18:00', '%H:%i')),
(37, 'Vendredi', STR_TO_DATE('08:00', '%H:%i'), STR_TO_DATE('09:00', '%H:%i')),
(38, 'Vendredi', STR_TO_DATE('09:00', '%H:%i'), STR_TO_DATE('10:00', '%H:%i')),
(39, 'Vendredi', STR_TO_DATE('10:00', '%H:%i'), STR_TO_DATE('11:00', '%H:%i')),
(40, 'Vendredi', STR_TO_DATE('11:00', '%H:%i'), STR_TO_DATE('12:00', '%H:%i')),
(41, 'Vendredi', STR_TO_DATE('13:00', '%H:%i'), STR_TO_DATE('14:00', '%H:%i')),
(42, 'Vendredi', STR_TO_DATE('14:00', '%H:%i'), STR_TO_DATE('15:00', '%H:%i')),
(43, 'Vendredi', STR_TO_DATE('15:00', '%H:%i'), STR_TO_DATE('16:00', '%H:%i')),
(44, 'Vendredi', STR_TO_DATE('16:00', '%H:%i'), STR_TO_DATE('17:00', '%H:%i')),
(45, 'Vendredi', STR_TO_DATE('17:00', '%H:%i'), STR_TO_DATE('18:00', '%H:%i'));
