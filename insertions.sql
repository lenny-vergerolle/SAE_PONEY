...
(1, 'Durand', 'Pierre', STR_TO_DATE('01/01/2000', '%d/%m/%Y'), 'H', '0701234567', 'pierre.durand@email.com', 70, TRUE),
(2, 'Roux', 'Chloé', STR_TO_DATE('14/02/1995', '%d/%m/%Y'), 'F', '0712345678', 'chloe.roux@email.com', 55, TRUE),
(3, 'Petit', 'Lucas', STR_TO_DATE('23/03/1998', '%d/%m/%Y'), 'H', '0723456789', 'lucas.petit@email.com', 80, FALSE),
(4, 'Blanc', 'Emma', STR_TO_DATE('30/04/1992', '%d/%m/%Y'), 'F', '0734567890', 'emma.blanc@email.com', 60, TRUE),
(5, 'Lemoine', 'Noah', STR_TO_DATE('15/05/1987', '%d/%m/%Y'), 'H', '0745678901', 'noah.lemoine@email.com', 75, FALSE),
(6, 'Giraud', 'Juliette', STR_TO_DATE('10/06/1990', '%d/%m/%Y'), 'F', '0756789012', 'juliette.giraud@email.com', 50, TRUE),
(7, 'Charpentier', 'Victor', STR_TO_DATE('05/07/1985', '%d/%m/%Y'), 'H', '0767890123', 'victor.charpentier@email.com', 85, TRUE),
(8, 'Faure', 'Alice', STR_TO_DATE('12/08/1993', '%d/%m/%Y'), 'F', '0778901234', 'alice.faure@email.com', 68, FALSE),
(9, 'Jacques', 'Léo', STR_TO_DATE('22/09/1988', '%d/%m/%Y'), 'H', '0789012345', 'leo.jacques@email.com', 90, TRUE),
(10, 'Boyer', 'Zoé', STR_TO_DATE('15/10/1991', '%d/%m/%Y'), 'F', '0790123456', 'zoe.boyer@email.com', 58, TRUE),
(11, 'Simon', 'Thomas', STR_TO_DATE('03/11/1994', '%d/%m/%Y'), 'H', '0712345679', 'thomas.simon@email.com', 65, TRUE),
(12, 'Perrot', 'Inès', STR_TO_DATE('25/12/1996', '%d/%m/%Y'), 'F', '0723456780', 'ines.perrot@email.com', 54, TRUE),
(13, 'Lefevre', 'Jules', STR_TO_DATE('19/01/1999', '%d/%m/%Y'), 'H', '0734567891', 'jules.lefevre@email.com', 72, FALSE),
(14, 'Cohen', 'Clara', STR_TO_DATE('27/02/1986', '%d/%m/%Y'), 'F', '0745678902', 'clara.cohen@email.com', 61, TRUE),
(15, 'David', 'Gabriel', STR_TO_DATE('30/03/1990', '%d/%m/%Y'), 'H', '0756789013', 'gabriel.david@email.com', 76, TRUE),
(16, 'Joly', 'Sophie', STR_TO_DATE('14/04/1992', '%d/%m/%Y'), 'F', '0767890124', 'sophie.joly@email.com', 59, FALSE),
(17, 'Mathieu', 'Alex', STR_TO_DATE('21/05/1995', '%d/%m/%Y'), 'H', '0778901235', 'alex.mathieu@email.com', 88, TRUE),
